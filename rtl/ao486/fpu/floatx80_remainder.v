...
module floatx80_remainder (
    ...
    wire [63:0]        b_sig_n;
    floatx80_normalize u_norm_b (.a(b), .sign_out(b_sign_n), .exp_out(b_exp_n), .sig_out(b_sig_n));
    ...
    wire [63:0]  rem_inc = (num_inc % {64'd0, b_sig_n});
    ...
    wire [127:0] q_k     = num_k / {64'd0, b_sig_n};
    wire [63:0]  rem_k   = (num_k % {64'd0, b_sig_n});
